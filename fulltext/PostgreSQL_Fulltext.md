...
### I. 初學者必讀：IMMUTABLE、STABLE、VOLATILE 是什麼？
...
### III. 將依賴的 system function 標記為 IMMUTABLE
...
### IV. 德哥方案：整行序列化為 text → 單一 GIN index
